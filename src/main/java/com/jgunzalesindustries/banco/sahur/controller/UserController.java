...
public class UserController implements Initializable {
    ...
    public void handleActualizar(ActionEvent event) {
        try {
            ...
            User user = construirUserDesdeFormulario(seleccionado.getUserID());
    ...
    private void cargarFormulario(User user) {
        ...
        for (Rol rol : comboBoxRol.getItems()) {
    ...
    private User construirUserDesdeFormulario(String userIdExistente) {
        ...
        // El passwordHash lo asigna el UserService (registro/actualización); aquí solo va vacío como placeholder.
        return new User(userIdExistente, name, lastName, email, "", rolID);
    }
}
